var URL = 'https://dev-search.boisestate.edu/'; // KEEP the trailing slash
var searchString = 'jessen';

describe('dev-search.boisestate.edu: Check that this site successfully uses the new search (Google Custom Search Element API 2.0)', function() {
